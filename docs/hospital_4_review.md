...
Historical H4 milestone: the final H2–5 pass is documented in [target review](target_hospitals_review.md) and the root README. H4 calculations below remain unchanged.
