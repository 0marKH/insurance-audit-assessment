...
def footer(canvas, document):
    ...
    canvas.drawString(38,23,'Insurance audit assessment | Frozen H1 / Hospitals 2-5 submission')
    ...
    for page_no,page in enumerate(text.split('<!-- pagebreak -->')):
        ...
        for block in page.strip().split('\n\n'):
            if block.startswith('|'):
                ...
                table=Table(content,colWidths=[518/len(content[0])]*len(content[0]),hAlign='LEFT')
